...
protected :
    ...
    // 电机初始化ID映射
    const Enum_Motor_DJI_ID Chassis_Motor_Id_Enum[4] = {
        Motor_DJI_ID_0x201,
        Motor_DJI_ID_0x202,
        Motor_DJI_ID_0x203,
        Motor_DJI_ID_0x204,
...
protected :
    ...
    // 左右轮中心距 (车宽)   543mm 
    const float Chassis_W = 0.543f;

    // 前后轮中心距 (车长) 384mm
    const float Chassis_L = 0.384f;

    // 底盘旋转中心到轮子中心的距离 (m) 332.53008mm
    const float Chassis_R = 0.33253008f;
...
public:
    // 4个舵轮电机对象
    Class_Motor_DJI_C610 Steering_Motor[4]; 
...
protected:
    ...
    const Enum_Motor_DJI_ID Steering_Motor_Id_Enum[4] = {
        Motor_DJI_ID_0x205,
        Motor_DJI_ID_0x206,
        Motor_DJI_ID_0x207,
        Motor_DJI_ID_0x208,
