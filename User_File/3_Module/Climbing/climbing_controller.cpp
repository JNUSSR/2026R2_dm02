...
void ClimbingController::ApplyMotorOutputWithComp(Class_Motor_DJI_C620 &motor, float comp, uint8_t can_byte_index)
{
...
uint8_t ClimbingController::IsWheelAngleDone(void)
{
    ...
    return (Basic_Math_Abs(err_l) <= WHEEL_ANGLE_DONE_TOL_RAD && Basic_Math_Abs(err_r) <= WHEEL_ANGLE_DONE_TOL_RAD);
}
...
void ClimbingController::Init(FDCAN_HandleTypeDef *hcan)
{
    ...
    motor_lift_front_.Init(hcan, Motor_DJI_ID_0x201, Motor_DJI_Control_Method_ANGLE);
    motor_lift_rear_.Init(hcan, Motor_DJI_ID_0x202, Motor_DJI_Control_Method_ANGLE);
    motor_wheel_l_.Init(hcan, Motor_DJI_ID_0x203, Motor_DJI_Control_Method_ANGLE);
    motor_wheel_r_.Init(hcan, Motor_DJI_ID_0x204, Motor_DJI_Control_Method_ANGLE);
...
Class_Motor_DJI_C620 &ClimbingController::GetMotorLiftFront(void)
{
    return motor_lift_front_;
}

Class_Motor_DJI_C620 &ClimbingController::GetMotorLiftRear(void)
{
    return motor_lift_rear_;
}

Class_Motor_DJI_C620 &ClimbingController::GetMotorWheelL(void)
{
    return motor_wheel_l_;
}

Class_Motor_DJI_C620 &ClimbingController::GetMotorWheelR(void)
{
