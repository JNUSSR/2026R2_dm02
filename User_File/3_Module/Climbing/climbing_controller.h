...
// 避免和 2_Device/Motor/Motor_DJI/dvc_motor_dji.h 里的同名宏冲突
...
private:
    ...
    void ApplyMotorOutputWithComp(Class_Motor_DJI_C620 &motor, float comp, uint8_t can_byte_index);
...
public:
    ...
    Class_Motor_DJI_C620 &GetMotorLiftFront(void);
    Class_Motor_DJI_C620 &GetMotorLiftRear(void);
    Class_Motor_DJI_C620 &GetMotorWheelL(void);
    Class_Motor_DJI_C620 &GetMotorWheelR(void);
